...
public class Quiz_4 {
        ...
        Question question_1 = new MultipleChoiceQuestion(
                ...
                " Vicente Del Bosque", " Duda", " Joachim Low", " Roberto Mancini", "Franz Beckenbauer", "e");
        question_1.check();
        ...
        Question question_3 = new MultipleChoiceQuestion(
                "Q14. Who Scored FC Barcelona's First Goal at the 2015 UCL Final?", " Luiz Suarez", " Neymar",
                " Jordi Alba", " Ivan Rakitic", "Andres Iniesta", "d");
        question_3.check();
        ...
        Question question_5 = new MultipleChoiceQuestion(
                "Q12. Which player holds the record for most Champions League winners medals?", " Raul", " Gento",
                " Di Stefano", " Puskas", "Miereles", "b");
        question_5.check();

        Question question_6 = new MultipleChoiceQuestion(
                "Q6. There have been two World Cup trophies. What was the name of the first?",
                " Delphine Romero Trophy", " Jules Rimet Trophy", " Aurier Louis Trophy", " Dino Melaye Trophy",
                "Olivier Anais Corentin Trophy", "b");
        question_6.check();

        Question question_7 = new MultipleChoiceQuestion("Q7. Who won the Second World Cup Hosted in 1934?", " Uruguay",
                " Italy", " Brazil", " West Germany", "Argentina", "b");
        question_7.check();
        ...
        Question question_12 = new TrueFalseQuestion("Q12. Jadon Sancho Was A Product Of FCBarcelona Football Academy",
                "false");
        question_12.check();

        Question question_13 = new TrueFalseQuestion(
                "Q13. As of 2021 Gerd Muller's record goals of 40 still stands in the Bundesliga", "false");
        question_13.check();

        Question question_14 = new TrueFalseQuestion("Q14. Cristiano Ronaldo Played For Manchester United", "true");
        question_14.check();
